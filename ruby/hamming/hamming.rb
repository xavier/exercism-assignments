# Already completed this assignment back when it was called 'Point Mutations'
# Let's just delegate to my previous implementation
module Hamming

  def self.compute(sequence, other_sequence)
    DNA.new(sequence).hamming_distance(other_sequence)
  end
